    ...
    public partial class SIO2_LogsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [sputtern].[SIO2_Logs] ([ImportDate], [FileName], [Filetpye], [Proces" +
                ...
                " HeaderWaferID, Recipe, Machine_ID, PCName, ParameterProcessTime, ChuckDrivePosi" +
                "tionCountActual, ChuckTempControlDCBiasActVoltage, ChuckTempControlSensor, Curre" +
                "ntStepNumber, DCActualCurrent, DCActualPower, DCActualVoltage, DCHardArcPerRun, " +
                "DCMicroArcPerRun, DCPowerCorrection, DCShieldLifeCounter, DCTargetLifeCounter, F" +
                "lexiCathMagnetPositionSensor, GasVacuumSystemGas1Sensor, GasVacuumSystemGas3Sens" +
                "or, GasVacuumSystemPressureReaderManagerPressure, GasVacuumSystemPressureReaderM" +
                "anagerWiderangeGaugeSensor, MatchingSeriesCapacitorPositionSensor, MatchingShunt" +
                "CapacitorPositionSensor, ProcessTimerTimeCorrection, RFBiasDCVoltageSensor, RFBi" +
                "asLoadPowerCorrection, RFBiasLoadPowerSensor, RFBiasReflectedPowerSensor, WaferI" +
                "DRead, zzEvent FROM sputtern.SIO2_Logs WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [sputtern].[SIO2_Logs] SET [ImportDate] = @ImportDate, [FileName] = @FileN" +
                ...
                " Filetpye, Processmodul, Lotnumber, Slotnumber, ProcessID, DateAndTime, HeaderWa" +
                "ferID, Recipe, Machine_ID, PCName, ParameterProcessTime, ChuckDrivePositionCount" +
                "Actual, ChuckTempControlDCBiasActVoltage, ChuckTempControlSensor, CurrentStepNum" +
                "ber, DCActualCurrent, DCActualPower, DCActualVoltage, DCHardArcPerRun, DCMicroAr" +
                "cPerRun, DCPowerCorrection, DCShieldLifeCounter, DCTargetLifeCounter, FlexiCathM" +
                "agnetPositionSensor, GasVacuumSystemGas1Sensor, GasVacuumSystemGas3Sensor, GasVa" +
                "cuumSystemPressureReaderManagerPressure, GasVacuumSystemPressureReaderManagerWid" +
                "erangeGaugeSensor, MatchingSeriesCapacitorPositionSensor, MatchingShuntCapacitor" +
                "PositionSensor, ProcessTimerTimeCorrection, RFBiasDCVoltageSensor, RFBiasLoadPow" +
                "erCorrection, RFBiasLoadPowerSensor, RFBiasReflectedPowerSensor, WaferIDRead, zz" +
                "Event FROM sputtern.SIO2_Logs WHERE (ID = @ID)";
